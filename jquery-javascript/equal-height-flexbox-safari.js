...
//function works when two options per line require the same height. Can be adapated to work with more than 2 items by modifying the for loop incremenet and the if statement that calculates the biggest size.

function resizeArticles() {
	//set the class that you have applied to your elements.
	var className = 'match-me';
...
window.onload = function() { resizeArticles(); };
window.onresize = function() { resizeArticles(); };
